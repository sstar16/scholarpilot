<template>
  <aside class="bucket-sidebar">
    ...
    <div
      ...
      :class="{ expanded: expandedBucket === b.key }"
      :data-bucket="b.key"
    >
      ...
      <!-- Drop zone (accepts dragged docs from other buckets) -->
      <div
...
// Listen for global dragend to clear state
if (typeof window !== 'undefined') {
  window.addEventListener('dragend', () => { dragging.value = null })
}
</script>
