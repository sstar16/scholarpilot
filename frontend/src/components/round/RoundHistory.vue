...
.s-complete { background: #dcfce7; color: #16a34a; }
.s-searching, .s-summarizing { background: #dbeafe; color: #2563eb; }
.s-awaiting_feedback, .s-awaiting_keywords { background: #fef3c7; color: #d97706; }
.s-failed { background: #fecaca; color: #dc2626; }
