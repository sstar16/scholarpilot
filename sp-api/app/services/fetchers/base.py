...
class FetcherRegistry:
    ...
    SOURCES: Dict[str, Dict] = {
        ...
        "wikipedia": {
            "name": "Wikipedia",
            "description": "维基百科（中/英），项目早期画像 / 术语澄清 / 背景知识",
        ...
        "tavily": {
            "name": "Tavily",
            "description": "LLM-optimized 通用 web 检索（需 TAVILY_API_KEY，免费 1k/月）",
            "doc_type": "web_page",
            "category": "general",
            "language": "multilingual",
            "phase": 1,
        ...
        "zenodo": {
            "name": "Zenodo",
            "description": "学术数据集 / 软件 / 预印本（CERN/OpenAIRE，DOI）",
            "doc_type": "dataset",
            "category": "data",
            "language": "multilingual",
            "phase": 1,
        ...
        "duckduckgo": {
            "name": "DuckDuckGo",
            "description": "通用 web 兜底（需 duckduckgo-search 库；默认禁，可在 DISABLED_SOURCES 移除）",
            "doc_type": "web_page",
            "category": "general",
            "language": "multilingual",
            "phase": 2,
        ...
        "github": {
            "name": "GitHub",
            "description": "代码仓库检索（含可选 GITHUB_TOKEN 提升限额至 5000/h）",
            "doc_type": "code_repo",
            "category": "code",
            "language": "multilingual",
            "phase": 1,
        ...
        "stackexchange": {
            "name": "Stack Exchange",
            "description": "Stack Overflow 等问答（默认 site=stackoverflow，300/day 不需 key）",
            "doc_type": "qa",
            "category": "qa",
            "language": "multilingual",
            "phase": 2,
