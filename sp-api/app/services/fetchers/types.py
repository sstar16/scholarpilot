...
#
# sp-api 版差异 vs backend: 删 bigquery_patents（不装 google-cloud-bigquery）
# 和 local_kb（不带本地知识库模块）。
SourceId = Literal[
    "pubmed",
    "openalex",
    "semantic_scholar",
    ...
    "clinical_trials",
    "crossref",
    # ── 2026-05-08 LDR-inspired 扩展（P0/P1）──────────────────────
    "wikipedia",
    "tavily",
    "zenodo",
    "duckduckgo",
...
CONDITIONAL_SOURCE_IDS: frozenset[str] = frozenset()
